...
const sections = [
   {
	...
	rows: [
		...
		{title: `${emojis} akinator`.toUpperCase(), rowId: `${usedPrefix}akinator`, description: ktx},
	    ...
	    {title: `${emojis} tebaksurah`.toUpperCase(), rowId: `${usedPrefix}tebaksurah`, description: ktx},
