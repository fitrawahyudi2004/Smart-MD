...
if (teks == 'virus') tags = {
 ...
 if (teks == 'nsfw') tags = {
  ...
  rows: [
      {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya Smart Bot ><"},
  ...
  {title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Smart Bot..."},
  ]
    },{
  ...
  {title: `⫹✨ › 𐐪-〚 Menfess 〛-𐑂`, rowId: ".menfess", description: "╰► Kalau ada gebetan bisa nich"},
...
const listMessage = {
  text: tek,
  footer: '© Smart Botz | ALL RESERVED',
