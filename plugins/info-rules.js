...
3. jika ingin membeli scrip bot Whatsapp bisa langsung Hubungi ke no Whatsapp:wa.me/6281262166032
...
conn.send3ButtonImg(m.chat, `${pickRandom(flaaa2)}` + `${ruls} ` + `${global.namebot}`, nth, rules, 'Menu', '.menu', 'Owner', '.owner', 'Credit', '.credit', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
